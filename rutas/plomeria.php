        ...
        <div class="row justify-content-center" style="margin: 0;">
            <div class="col-auto menu">
                ...
                <div class="form-group formulario">
                        ...
                        <input type="text" class="form-control" id="titulo" placeholder="REPARACION BAÑO">
                    <hr>
                    <p>Nombre Elemento:</p>
                    <input type="text" class="form-control" id="nombre" placeholder="TUBO DE COBRE" autocomplete="off">
